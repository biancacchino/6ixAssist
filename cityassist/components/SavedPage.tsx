...
const SavedPage: React.FC = () => {
  ...
  const getCategoryIcon = (category: string) => {
    if (category.toLowerCase().includes('food')) {
      return <svg className="w-10 h-10 text-indigo-700" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z" /></svg>;
    }
    if (category.toLowerCase().includes('shelter') || category.toLowerCase().includes('housing')) {
  ...
  return (
    <div className="flex flex-col h-full bg-gradient-to-b from-indigo-50 via-white to-purple-50 overflow-y-auto">
      ...
      <div className="w-full max-w-3xl mx-auto px-6 py-8">
        ...
        <div className="mb-6">
          <h2 className="text-3xl font-semibold text-gray-800 mb-2">Your Saved Places</h2>
          <p className="text-gray-600">Quick access to the resources you use most</p>
        </div>
        ...
        {savedResources.length > 0 ? (
          <div className="space-y-4">
            {savedResources.map((resource) => (
              <div
                key={resource.id}
                className="bg-white rounded-2xl p-6 hover:bg-indigo-50 transition-all duration-300 ease-out border-2 border-indigo-100 hover:border-indigo-300 hover:shadow-md"
              >
                <div className="flex items-start gap-4">
                  ...
                  <button 
                    ...
                    className="text-amber-500 hover:scale-110 transition-all duration-200 ease-out active:scale-95"
          ...
          <div className="text-center py-16">
            ...
            <h2 className="text-2xl font-semibold text-gray-800 mb-3">No saved places yet</h2>
