  ...
  return (
    ...
    >
      ...
      <div className="flex justify-between items-start pr-6">
        ...
        >
          <svg className={`w-6 h-6 ${isSaved ? 'text-amber-500' : 'text-gray-400 hover:text-amber-500'}`} fill={isSaved ? 'currentColor' : 'none'} stroke="currentColor" strokeWidth={isSaved ? '0' : '2'} viewBox="0 0 24 24">
      ...
      <div className="flex flex-wrap gap-2 mt-1 mb-2">
        ...
        {crowdStatus && (
          <span className={`text-xs font-semibold px-2 py-1 rounded-full ${
            crowdStatus === 'busy' ? 'bg-yellow-100 text-yellow-700' : 'bg-green-100 text-green-700'
          }`}>
          ...
          <div className="mt-3 pt-3 border-t border-slate-200">
            ...
            {showContribute && (
              <div className="mt-3 space-y-2" onClick={(e) => e.stopPropagation()}>
                <p className="text-xs text-slate-600 font-medium">How busy is it right now?</p>
