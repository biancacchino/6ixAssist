...
const SettingsPage: React.FC = () => {
  ...
  return (
    <div className={`flex flex-col h-full overflow-y-auto transition-colors duration-300 ${
      darkMode ? 'bg-gradient-to-b from-gray-800 via-gray-900 to-gray-800' : 'bg-gradient-to-b from-indigo-50 via-white to-purple-50'
    }`}>
      <div className="w-full max-w-3xl mx-auto px-6 py-8">
        ...
        <div className="mb-8">
          ...
          }`}>Manage your preferences and account</p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className={`rounded-2xl p-6 border-2 transition-all duration-300 ${
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className={`text-sm transition-colors duration-300 ${
                    darkMode ? 'text-gray-400' : 'text-gray-600'
                  }`}>Allow app to access your location</p>
                </div>
                <button
                  onClick={() => setLocationSharing(!locationSharing)}
                  className={`relative w-14 h-7 rounded-full transition-all duration-300 ${
                    locationSharing ? 'bg-indigo-500' : darkMode ? 'bg-gray-600' : 'bg-gray-300'
                  }`}
                >
                  <span
              ...
              <div className={`border-t pt-4 transition-colors duration-300 ${
                ...
                <button className={`text-sm font-medium transition-all duration-300 ease-out hover:underline ${
                  darkMode ? 'text-indigo-400 hover:text-indigo-300' : 'text-indigo-700 hover:text-indigo-800'
                }`}>
          ...
          <div className={`rounded-2xl p-6 border-2 transition-all duration-300 ${
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className={`text-sm transition-colors duration-300 ${
                  darkMode ? 'text-gray-400' : 'text-gray-600'
                }`}>Get updates about nearby resources</p>
              </div>
              <button
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className={`text-sm transition-colors duration-300 ${
                    darkMode ? 'text-gray-400' : 'text-gray-600'
                  }`}>Reduce eye strain in low light</p>
                </div>
                <button
              ...
              <div className={`border-t pt-4 transition-colors duration-300 ${
                ...
                <select
                  ...
                  className={`w-full px-4 py-2 border-2 rounded-xl focus:outline-none focus:border-indigo-500 transition-all duration-300 ${
                    darkMode ? 'bg-gray-700 border-gray-600 text-gray-200' : 'bg-gray-50 border-indigo-200 text-gray-800'
                  }`}
                >
          ...
          <div className={`rounded-2xl p-6 border-2 transition-all duration-300 ${
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className={`border-t pt-3 transition-colors duration-300 ${
                ...
                <button className={`font-medium transition-all duration-300 ease-out hover:underline ${
                  darkMode ? 'text-indigo-400 hover:text-indigo-300' : 'text-indigo-700 hover:text-indigo-800'
          ...
          {/* Danger Zone */}
          <div className={`rounded-2xl p-6 border-2 transition-all duration-300 ${
            darkMode ? 'bg-rose-950 border-rose-900' : 'bg-rose-50 border-rose-200'
          }`}>
